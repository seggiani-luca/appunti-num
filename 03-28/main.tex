...
A questo punto un semplice programma dovrà semplicemente usare le funzioni per il caricamento dell'ambiente di \lstinline|mat.h| e chiamare la funzione \lstinline|jacobi()|:
\begin{lstlisting}[language=C++, style=codestyle]	
int main() {
...
\subsubsection{Implementazione C++ del meotod di Gauss-Seidel}
